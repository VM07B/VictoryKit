...
import { DEFAULT_SETTINGS, NAV_ITEMS, SYSTEM_PROMPT } from "../constants";
...
const NeuralLinkInterface: React.FC = () => {
  const [sessions, setSessions] = useState<ChatSession[]>([
    {
      id: "1",
      name: "BotDefender Session",
      active: true,
      messages: [
        {
          id: "1",
          sender: "SYSTEM",
          text: "BotDefender AI initialized. I can help you detect bots, configure CAPTCHAs, and analyze behavior patterns.",
      ...
      messages: [
        {
          id: "1",
          sender: "SYSTEM",
          text: "New BotDefender session started.",
          timestamp: new Date().toISOString(),
        },
      ],
      settings: DEFAULT_SETTINGS,
        ...
        <div className="p-4 border-t border-gray-700">
          <div className="flex gap-4">
            <input
              ...
              placeholder="Ask about bot detection, CAPTCHA, behavior analysis..."
