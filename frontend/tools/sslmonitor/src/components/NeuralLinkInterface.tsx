...
const NeuralLinkInterface: React.FC = () => {
  const [sessions, setSessions] = useState<ChatSession[]>([
    {
      id: "1",
      name: "SSLMonitor Session",
      active: true,
      messages: [
        {
          id: "1",
          sender: "SYSTEM",
          text: "SSLMonitor AI initialized. I can help you scan certificates, check expirations, and analyze security grades.",
      ...
      messages: [
        {
          id: "1",
          sender: "SYSTEM",
          text: "New SSLMonitor session started.",
          timestamp: new Date().toISOString(),
        },
      ],
      settings: DEFAULT_SETTINGS,
        ...
        <header className="bg-gray-900/80 border-b border-gray-700 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">SSL Certificate AI</p>
            </div>
          </div>
          <button
        ...
        <div className="p-4 border-t border-gray-700">
          <div className="flex gap-4">
            <input
              ...
              placeholder="Ask about SSL certificates, security grades, expiration..."
