      ...
      messages: [
        {
          id: "1",
          sender: "SYSTEM",
          text: "SIEMCommander AI initialized. I can help you search logs, create correlation rules, and manage security alerts.",
        ...
        <header className="bg-gray-900/80 border-b border-gray-700 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">SIEM AI Assistant</p>
            </div>
          </div>
          <button
        ...
        <div className="p-4 border-t border-gray-700">
          <div className="flex gap-4">
            <input
              ...
              placeholder="Ask about log searches, correlation rules, alert management..."
