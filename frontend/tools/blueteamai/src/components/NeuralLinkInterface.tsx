...
const NeuralLinkInterface: React.FC = () => {
  const [sessions, setSessions] = useState<ChatSession[]>([
    {
      id: "1",
      name: "BlueTeam Session",
      active: true,
      messages: [
        {
          id: "1",
          sender: "SYSTEM",
          text: "BlueTeamAI initialized. I can help you with threat hunting, incident response, and digital forensics.",
      ...
      messages: [
        {
          id: "1",
          sender: "SYSTEM",
          text: "New BlueTeam session started.",
          timestamp: new Date().toISOString(),
        },
      ],
      settings: DEFAULT_SETTINGS,
        ...
        <header className="bg-gray-900/80 border-b border-gray-700 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Defensive Security AI</p>
            </div>
          </div>
          <button
        ...
        <div className="p-4 border-t border-gray-700">
          <div className="flex gap-4">
            <input
              ...
              placeholder="Ask about threat hunting, incident response, forensics..."
