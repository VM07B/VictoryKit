            ...
            {isAnalyzing && (
              <div className="mb-4">
                ...
                <div className="h-2 bg-orange-950 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-gradient-to-r from-orange-500 to-red-400 transition-all animate-pipelineFlow"
                  ...
                  <div className="relative w-24 h-24 mx-auto mb-2">
                    <svg className="w-full h-full transform -rotate-90">
                      ...
                      <circle
                        ...
                        strokeWidth="8"
                        fill="none"
                        strokeDasharray={`${result.securityScore * 2.51} 251`}
                        strokeLinecap="round"
                      />
                    </svg>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="p-3 rounded-lg bg-orange-950/50 text-center">
                    <p className="text-xl font-bold text-green-400">
                      {result.passedStages}/{result.totalStages}
                    </p>
                    <p className="text-xs text-orange-400">Stages Passed</p>
                  </div>
                  <div className="p-3 rounded-lg bg-orange-950/50 text-center">
                    <p className="text-xl font-bold text-orange-400">
                      {result.vulnerabilities.reduce((a, b) => a + b.count, 0)}
                    </p>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-4 gap-1">
                    {result.vulnerabilities.map((v) => (
                      <div
                        key={v.severity}
                        className="p-2 rounded bg-orange-950/50 text-center"
                      >
                        <p
