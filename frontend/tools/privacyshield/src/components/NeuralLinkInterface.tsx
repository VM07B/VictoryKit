      ...
      <div className="flex-1 container mx-auto p-4 flex flex-col max-w-4xl">
        <div className="flex-1 overflow-y-auto space-y-4 mb-4">
          {messages.length === 0 && (
            <div className="text-center py-12">
              ...
              <h2 className="text-2xl font-bold mb-2">PrivacyShield AI</h2>
              <p className="text-gray-400 mb-6">
                Your privacy compliance expert. Ask about GDPR, CCPA, data
                subject rights, and privacy protection.
              </p>
              <div className="flex flex-wrap justify-center gap-2">
                {suggestedPrompts.map((prompt) => (
                  <button
                    ...
                    className="px-3 py-2 bg-gray-800 border border-gray-700 rounded-lg text-sm hover:border-indigo-500 transition-colors"
                  >
                    {prompt}
                  </button>
                ))}
        ...
        <form onSubmit={handleSubmit} className="flex gap-2">
          <input
            ...
            className="flex-1 bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 focus:outline-none focus:border-indigo-500"
            disabled={isLoading}
          />
          <button
            type="submit"
